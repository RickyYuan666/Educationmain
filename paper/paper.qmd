...
subtitle: "Unpacking the Influence of Race on Educational Returns: Exploring Variations by Gender"
author:
  - Ricky Yuan
...
cleaned_data <- read_csv("data/analysisdata/econ_clean.csv")
...
```{r, warning=FALSE, message=FALSE, echo=FALSE}
#| label: fig-education_age_boxplot_overlay
#| fig-cap: "Boxplot with overlay showing the relationship between education levels and age, highlighting the age distribution across different educational attainments."
#| echo: false
#| fig.width: 8
#| fig.height: 6
...
cleaned_data %>%
  ...
  geom_jitter(aes(color = escolaridade_transf), width = 0.2, alpha = 0.6, size = 1.5) + # Add overlay points
  scale_fill_manual(values = c("#FFD700", "#87CEEB", "#FF69B4")) + # Bright colors for boxplot
  scale_color_manual(values = c("#FFA500", "#4682B4", "#FF69B4")) + # Different color palette for jitter points
  labs(
